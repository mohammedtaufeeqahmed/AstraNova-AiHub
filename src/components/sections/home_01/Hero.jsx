        ...
        <div className='relative z-[1] overflow-hidden rounded-bl-[30px] rounded-br-[30px] bg-colorLinenRuffle pb-20 pt-28 lg:rounded-bl-[50px] lg:rounded-br-[50px] lg:pb-24 lg:pt-32 xl:pt-40 xxl:pb-[133px] xxl:pt-[195px]'>
          <div className='global-container'>
            <div className='mb-14 flex flex-col items-center text-center lg:mb-20'>
              <h1 className='jos h1-title slide-from-bottom mb-6 max-w-[510px] lg:max-w-[768px] xl:max-w-[1076px]'>
              ...
              At AstraNova, we empower innovators with tools and resources to advance AI. 
              Our platform offers free and subscription-based datasets and models, making
           ...
           <div
            ...
            >
              <img
                src='assets/img/th-1/hero-dashboard2.jpg'
                alt='hero-dashboard'
                width='1296'
                height='640'
